...
import { PrismaFavoritePromptRepository, PrismaFavoritePromptReadRepository } from './persistence';
import { FavoritePromptRepository, FavoritePromptReadRepository } from '../application';
